...
public class Alarms {
	...
	public static final String ALARM_ALERT_ACTION = "com.androsz.electricsleep.alarmclock.ALARM_ALERT";
	...
	public static final String ALARM_DONE_ACTION = "com.androsz.electricsleep.alarmclock.ALARM_DONE";
	...
	// ALARM_DONE_ACTION).
	public static final String ALARM_SNOOZE_ACTION = "com.androsz.electricsleep.alarmclock.ALARM_SNOOZE";

	// A public action that is broadcasted when the user cancels snoozing
	// Other applications may listen for this.
	public static final String ALARM_SNOOZE_CANCELED_BY_USER_ACTION = "com.androsz.electricsleep.alarmclock.ALARM_SNOOZE_CANCELED_BY_USER";

	// AlarmAlertFullScreen listens for this broadcast intent, so that other
	// applications
	// can dismiss the alarm (after ALARM_ALERT_ACTION and before
	// ALARM_DONE_ACTION).
	public static final String ALARM_DISMISS_ACTION = "com.androsz.electricsleep.alarmclock.ALARM_DISMISS";

	// A public action that is broadcasted when the user dismisses an alarm.
	// Other applications may listen for this to.
	public static final String ALARM_DISMISSED_BY_USER_ACTION = "com.androsz.electricsleep.alarmclock.ALARM_DISMISSED_BY_USER";

	// This is a private action used by the AlarmKlaxon to update the UI to
	// show the alarm has been killed.
	public static final String ALARM_KILLED = "com.androsz.electricsleep.alarmclock.alarm_killed";

	// Extra in the ALARM_KILLED intent to indicate to the user how long the
	// alarm played before being killed.
	public static final String ALARM_KILLED_TIMEOUT = "com.androsz.electricsleep.alarmclock.alarm_killed_timeout";

	// This string is used to indicate a silent alarm in the db.
	public static final String ALARM_ALERT_SILENT = "com.androsz.electricsleep.alarmclock.silent";

	// This intent is sent from the notification when the user cancels the
	// snooze alert.
	public static final String CANCEL_SNOOZE = "com.androsz.electricsleep.alarmclock.cancel_snooze";
