...
public class ReviewSleepActivity extends CustomTitlebarActivity {
	...
	protected void onRestoreInstanceState(final Bundle savedState) {
		...
		/*sleepChartGraphicalView.xyMultipleSeriesDataset = (XYMultipleSeriesDataset) savedState
				.getSerializable("dataset");
		sleepChartGraphicalView.xyMultipleSeriesRenderer = (XYMultipleSeriesRenderer) savedState
				.getSerializable("renderer");

		sleepChartGraphicalView.xySeriesMovement = (XYSeries) savedState
				.getSerializable("seriesMovement");
		sleepChartGraphicalView.xySeriesMovementRenderer = (XYSeriesRenderer) savedState
		...
		sleepChartGraphicalView.xySeriesAlarmTriggerRenderer = (XYSeriesRenderer) savedState
