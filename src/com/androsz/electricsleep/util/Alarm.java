 ...
 * Copied from AOSP into ElectricSleep by Androsz 2010. includes slight modifications.
 *
...
public final class Alarm implements Parcelable {
	...
	public static class Columns implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri
				.parse("content://com.androsz.electricsleep.alarmclock/alarm");
	...
	static final class DaysOfWeek {
		...
		public String toString(final Context context, final boolean showNever) {
			...
			/*
			 * // no days if (mDays == 0) { return showNever ?
			 * context.getText(R.string.never).toString() : ""; }
			 * 
			 * // every day if (mDays == 0x7f) { return
			 * context.getText(R.string.every_day).toString(); }
			 * 
			 * // count selected days int dayCount = 0, days = mDays; while
			 * (days > 0) { if ((days & 1) == 1) dayCount++; days >>= 1; }
			 * 
			 * // short or long form? DateFormatSymbols dfs = new
			 * DateFormatSymbols(); String[] dayList = (dayCount > 1) ?
			 * dfs.getShortWeekdays() : dfs.getWeekdays();
			 * 
			 * // selected days for (int i = 0; i < 7; i++) { if ((mDays & (1 <<
			 * i)) != 0) { ret.append(dayList[DAY_MAP[i]]); dayCount -= 1; if
			 * (dayCount > 0) ret.append( context.getText(R.string.day_concat));
			 * } }
			 */
			return ret.toString();
		}
	...
	public Calendar nearestAlarmDate;
	...
	public Alarm(final Cursor c) {
		...
		final String ALARM_ALERT_SILENT = "silent";
	...
	public Calendar getNearestAlarmDate() {
		if (nearestAlarmDate == null) {
			nearestAlarmDate = calculateNextAlarm(hour, minutes, daysOfWeek,
