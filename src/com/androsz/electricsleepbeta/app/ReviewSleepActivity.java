...
public class ReviewSleepActivity extends HostActivity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		bar.addTab(bar.newTab().setText(R.string.sleep_chart)); //layout R.id.sleep_movement_chart
		bar.addTab(bar.newTab().setText(R.string.analysis));//addTab(R.id.sleep_analysis_table, R.string.analysis);
