...
public class PointD implements Serializable {
	...
	public static List<org.achartengine.model.PointD> convertToNew(List<PointD> oldList) {
		ArrayList<org.achartengine.model.PointD> newList = new ArrayList<org.achartengine.model.PointD>(oldList.size());
		for(PointD oldPoint : oldList)
		{
			newList.add(new org.achartengine.model.PointD(oldPoint.x, oldPoint.y));
		}
		return newList;
	}
}